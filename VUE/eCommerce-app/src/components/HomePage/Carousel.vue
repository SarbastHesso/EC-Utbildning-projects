            ...
            <div class="view">
              <a href="#!">
                ...
                >
                  <div class="row">
                    <div class="col-12">
                      <p class="h1-responsive red-text font-weight-bold mb-0">
                        Sale off 30% on every saturday!
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <a>
                ...
                >
                  <div class="row">
                    <div class="col-12">
                      <p
                        class="h1-responsive indigo-text font-weight-bold mb-0"
                      >
                        Promotion on each smartphone!
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <a>
                ...
                >
                  <div class="row">
                    <div class="col-12">
                      <p
                        class="h1-responsive orange-text font-weight-bold mb-0"
                      >
                        Sale off 20% on every headphones!
                      </p>
                    </div>
                  </div>
                </div>
